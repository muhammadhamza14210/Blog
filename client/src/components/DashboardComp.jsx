...
export default function DashboardComp() {
  ...
  return (
    <div className="p-3 md:mx-auto ">
      ...
      <div className="flex flex-wrap gap-4 py-2 mx-auto justify-center">
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 m-1 rounded-md dark:bg-gray-800">
